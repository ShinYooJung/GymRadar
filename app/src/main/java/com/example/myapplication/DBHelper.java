...
class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE TrainingCenter(ID NUM, NAME TEXT, ADDR TEXT, COORDINATEX REAL, COORDINATEY REAL)");
    } // 생성과 동시에 진행되어야 하는 내용
    ...
    public void insertTC(Integer id, String name, String addr, float coordinateX, float coordinateY) {
        SQLiteDatabase db = getWritableDatabase();
        db.execSQL("INSERT INTO TrainingCenter VALUES("+id+",'" + name + "', '" + addr + "', " + coordinateX + ", " + coordinateY + ")");
        db.close();
